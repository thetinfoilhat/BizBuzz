...
// 2026 Fish Tank — structure identical to 2025, emerald theme, content TBD
const heroSlides = [
...
// Placeholder winners — TBD after competition
const competitionWinners = [
  {
    ...
    description: "The 2026 Fish Tank champion will be announced after the competition. Check back here for results.",
  },
  {
    placement: "2nd Place",
    team: "TBD",
    ...
    description: "Winner details will be announced after the 2026 Fish Tank competition.",
  },
  {
    placement: "3rd Place",
    team: "TBD",
...
// Placeholder finals judges — TBD
const finalsJudges = [
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Finals judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Finals judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Finals judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Finals judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Finals judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
...
// Placeholder prelim judges — TBD
const prelimJudges = [
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Preliminary judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Preliminary judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Preliminary judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Preliminary judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
  { name: "TBD", title: "Details Coming Soon", image: "", bio: "Preliminary judge details for the 2026 Fish Tank competition will be announced ahead of the event." },
...
export default function FishTank2026Page() {
  ...
  const renderJudgePhoto = (
    ...
    <div className="relative h-52 overflow-hidden">
      ...
      <div
        className="absolute top-4 left-4 inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold tracking-[0.3em] uppercase"
        style={{ background: badgeColor, color: '#0b1120' }}
      >
        {badge}
      </div>
    </div>
  ...
  const nextImage = () => setCurrentImageIndex((prev) => (prev + 1) % fishTankPhotos.length);
  const prevImage = () => setCurrentImageIndex((prev) => (prev - 1 + fishTankPhotos.length) % fishTankPhotos.length);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        {/* Background with emerald overlay */}
        <div className="absolute inset-0 z-0">
          <Image
            src={fishTankPhotos[0]}
            alt="Fish Tank 2026 background"
            fill
            priority
            className="object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#064e3b]/95 via-[#065f46]/90 to-[#10b981]/85"></div>
        </div>

        {/* Bubble decorations */}
        <div className="absolute top-60 right-40 w-80 h-80 rounded-full bg-[#10b981]/10 blur-2xl"></div>
        <div className="absolute bottom-20 left-40 w-96 h-96 rounded-full bg-[#10b981]/10 blur-2xl"></div>
        <div className="absolute top-40 left-1/4 w-64 h-64 rounded-full bg-[#34d399]/10 blur-2xl"></div>
            ...
            <div className="flex flex-col justify-center">
              ...
              >
                <h1 className="text-left mb-10">
                  ...
                  <span className="block text-8xl font-extrabold tracking-tight text-[#10b981] leading-none">TANK</span>
                </h1>
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-[#064e3b]/40 backdrop-blur-sm rounded-xl p-7 border border-white/10 shadow-lg mb-12"
              >
              ...
              >
                <motion.div variants={fadeIn} className="bg-[#064e3b]/40 backdrop-blur-sm rounded-xl py-6 px-3 text-center border border-white/10">
                  <div className="text-4xl font-bold text-[#10b981]">TBD</div>
              ...
              >
                <a
                  ...
                  className="inline-flex items-center px-8 py-4 bg-white text-[#064e3b] text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition duration-300"
                >
                  Learn More
                ...
                <a
                  href="#"
                  className="inline-flex items-center px-8 py-4 bg-[#10b981] text-white text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition duration-300"
                >
                  Apply Now
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[560px] border border-white/10">
                {heroSlides.map((photo, index) => (
                  ...
                  >
                    <Image
                      src={photo}
                      alt={`Fish Tank 2026 slide ${index + 1}`}
                      fill
                      className="object-cover"
                      priority={index === 0}
                    />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/70 via-black/40 to-transparent text-white">
                  <h3 className="text-2xl font-bold mb-1">Date TBD, 2026</h3>
                  <p className="text-lg">Location TBD, Naperville Area</p>
                </div>
                ...
                <div className="absolute bottom-6 right-6 flex space-x-3 z-10">
                  {heroSlides.map((_, idx) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-colors duration-300 ${activeSlide === idx ? 'bg-white' : 'bg-white/40'}`}
      ...
      <section id="what-is-fish-tank" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 bg-[#10b981]/20 text-[#064e3b] rounded-full text-sm font-medium mb-4">
              The Competition
            </span>
            <h2 className="text-6xl font-bold text-[#0f172a]">
              What is <span className="text-[#10b981]">Fish Tank</span>?
            </h2>
          </div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-12">
              <div className="flex items-center mb-4">
                <div className="w-1.5 h-12 bg-[#10b981] mr-5 rounded-full"></div>
              ...
              <div className="max-w-3xl">
                ...
                <p className="text-xl leading-relaxed text-white mb-6">
                  Hosted at a Chicagoland venue in Summer 2026 with some of Naperville&apos;s biggest business owners and leaders, participants will take their big innovations to an even bigger stage.
                </p>
              </div>
              <div className="flex items-center gap-3 mt-2">
                ...
                <span className="text-white font-medium">Date TBD, 2026</span>
                ...
                <span className="text-white font-medium">Location TBD, Naperville Area</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#10b981] via-[#34d399] to-[#10b981] flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-[#000000] mb-3">Day 1: Preliminary Round</h3>
              <p className="text-gray-700 mb-4">Date TBD, 2026</p>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
                ...
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
                  <span>Top finalists selected to advance</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
            ...
            >
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
                  <span>Top finalists pitch to a panel of industry leaders</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
                ...
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
                  <span>Top winners awarded prize funding</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 rounded-full bg-[#10b981] mt-2 flex-shrink-0"></div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#10b981] rounded-2xl p-8 text-white text-center"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                ...
                <div className="text-sm text-emerald-100">First Place</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl font-bold mb-2">🥈</div>
                <div className="text-2xl font-bold mb-1">TBD</div>
                <div className="text-sm text-emerald-100">Second Place</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl font-bold mb-2">🥉</div>
                <div className="text-2xl font-bold mb-1">TBD</div>
                <div className="text-sm text-emerald-100">Third Place</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl font-bold mb-2">🏆</div>
                <div className="text-2xl font-bold mb-1">TBD</div>
                <div className="text-sm text-emerald-100">Fourth Place</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6">
                <div className="text-4xl font-bold mb-2">⭐</div>
                <div className="text-2xl font-bold mb-1">TBD</div>
                <div className="text-sm text-emerald-100">Fifth Place</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#000000] mb-4">
              Fish Tank 2026 Highlights
            </h2>
            <p className="text-2xl text-gray-700">
              Photos from the 2026 competition will appear here after the event
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {fishTankPhotos.map((photo, idx) => (
              ...
              >
                <Image src={photo} alt={`Fish Tank 2026 Photo ${idx + 1}`} fill className="object-cover hover:scale-110 transition-transform duration-300" />
              </motion.div>
            ))}
          </div>
        </div>
          ...
          {firstWinner && (
            ...
            >
              ...
              <div className="flex-1 p-10 lg:p-14 flex flex-col gap-6">
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/10 border border-white/20 rounded-full text-xs tracking-[0.4em] uppercase text-[#10b981] font-semibold w-fit">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8">
              {runnerUps.map((winner, idx) => (
                <motion.div
                  ...
                  className="group bg-white/7 border border-white/12 rounded-[28px] shadow-xl backdrop-blur-lg overflow-hidden flex flex-col hover:border-[#10b981]/50 hover:shadow-[#10b981]/20 transition-all duration-300"
                >
                  <div className="relative h-56">
                    ...
                    <div className="absolute top-4 left-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#10b981]/95 text-white text-[11px] font-semibold tracking-[0.3em] uppercase shadow-lg">
                      {winner.placement}
                    </div>
                  </div>
                  <div className="p-7 flex flex-col gap-3 flex-1">
                    <div>
                      <h4 className="text-2xl font-semibold text-white leading-snug group-hover:text-[#10b981] transition-colors duration-300">
                        {winner.project}
                      </h4>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-[#000000] mb-4">Finals Judges</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Industry leaders who will evaluate our top finalists and select the 2026 champions.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10 auto-rows-fr">
            {finalsJudges.map((judge, idx) => (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-xl border border-emerald-100/60 overflow-hidden flex flex-col h-full min-h-[420px]"
              >
                {renderJudgePhoto(
                  judge.image || undefined,
                  judge.name,
                ...
                <div className="p-6 flex flex-col gap-3 flex-1">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-medium text-[#10b981]">{judge.title}</p>
                  </div>
                  <p className="text-sm text-gray-600 leading-relaxed">{judge.bio}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-[#000000] mb-4">Preliminary Judges</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Emerging leaders who will guide every team through the opening round of pitches.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 auto-rows-fr">
            {prelimTop.map((judge, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="bg-white rounded-2xl shadow-xl border border-[#10b981]/30 overflow-hidden flex flex-col h-full min-h-[420px]"
              >
                {renderJudgePhoto(
                  judge.image || undefined,
                  judge.name,
      ...
      {/* ── CTA Section ── */}
      <section className="py-16 bg-gradient-to-r from-[#064e3b] via-[#065f46] to-[#10b981]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Registration for Fish Tank 2026 opens in Spring 2026. Join our camp program to get early access.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/camps-2026" className="px-8 py-4 bg-white text-[#064e3b] font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all">
                View 2026 Summer Camp
              </Link>
              <Link href="/about" className="px-8 py-4 bg-white/20 backdrop-blur-sm text-white border border-white/30 font-semibold rounded-xl hover:bg-white/30 transition-all">
                About BizBuzz
              </Link>
            </div>
          </motion.div>
        ...
        >
          ...
          >
            <Image
              ...
              alt={`Fish Tank 2026 Photo ${currentImageIndex + 1}`}
              fill
